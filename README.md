...
**현재 버전: `v0.5.1`** (버전의 단일 출처는 `kasa-hwpx/SKILL.md` 프런트매터의 `version` 필드이며,
...
- `v0.5.1` feat: `v0.5.0` 업스트림 반영분 재릴리스 — 재기안 가드레일(전 섹션·mixed content 보호·미적중 키 경고), zip 메타데이터 보존 기록, 검증 강화(세로쓰기 오변환·표 셀 과밀·itemCnt 정합) **(현재)**
