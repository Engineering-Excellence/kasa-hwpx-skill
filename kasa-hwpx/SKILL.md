...
- 한자리 시(`5:08`)를 그대로 보존하므로 `validate --kasa`의 표기법 lint가 "두 자리로"
  경고할 수 있다 — 순연 도구는 표기를 정규화하지 않는다(내용 무단 변경 금지). 표기를
  고칠지는 사용자에게 확인한다.
